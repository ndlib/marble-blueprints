...
export interface IImageDeploymentPipelineStackProps extends cdk.StackProps {
...
export class ImageDeploymentPipelineStack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props: IImageDeploymentPipelineStackProps) {
