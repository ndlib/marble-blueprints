...
//   })
  ...
  //   describe('template monkey patches', () => {
      ...
      // // No resource with type AWS:: Serverless::LayerVersion found
      //   const subject = stack()
      //   const template = Template.fromStack(subject)
    ...
    //   // No resource with type AWS:: Serverless::Function found
    //     const subject = stack()
    //     const template = Template.fromStack(subject)
    ...
    // // No resource with type AWS::Serverless::Api found
    //   const subject = stack()
    //   const template = Template.fromStack(subject)
